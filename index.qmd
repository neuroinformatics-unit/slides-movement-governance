...
- Challenges to scaling governance
...
- **Maintainers** make day-to-day decisions, e.g. merging PRs, closing issues.
...
## Which *implicit* norms should be made *explicit*?

- **Feedback culture**, especially around code reviews
- **Decision-making** modes and processes
- **Defining roles and pathways** for maintainers, tech lead, collaborators
...
::: {.fragment}
- Gradually move towards a "Circles" model, with sub-teams having autonomy over specific areas.
